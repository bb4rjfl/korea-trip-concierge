...
- [ ] **🔥 다음: ① (D-037) 재배포 후 라이브 확인 ② (사용자 허용 후) 시나리오 테스트 ③ 추가 콘텐츠/폴리시: 코스 원클릭 길찾기·영업시간 인라인·다국어 코스, 명소/동네/스팟 확대, getArrInfoByRoute 정밀화**. (PlayMCP 심사요청=보류, 사용자 결정 대기 — 재촉 금지. 노출키 재발급=사용자 스킵. 비즈폼 사업자번호 png 교체=사용자 액션 대기.) 상세 **docs/25 §0.5·§10**.
