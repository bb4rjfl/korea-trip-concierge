...
- [x] **완성도 라운드(2026-06-27, D-020)**: 저우선 잔여(P3 temple-stay 라우팅·Jamsil 면책·P4 특정업소 투명안내) + 콘텐츠(explainKoreanService **+은행/송금**=12서비스, explainPayment +찜질방, 메뉴 +6, 명소 43→50, 동네 29→32). 부수: 가입 매처 bare `account` 충돌 제거. **212 tests green, tsc·빌드 클린.** ⏳ 재배포 대기.
