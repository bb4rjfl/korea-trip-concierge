...
- **데이터**: **큐레이션 동네가이드**(키 불필요·항상 동작). **32개 동네**(D-014로 8→21, D-017로 21→26, D-018로 26→29, D-020로 29→32): 서울 23(명동·홍대·강남·인사동·성수·이태원·북촌·동대문·여의도·잠실/롯데월드·익선동·을지로·삼청동·가로수길/신사·연남·압구정/청담·종로/광화문·합정/망원·서촌·건대·신촌/이대 + **해방촌/경리단·대학로**), **부산 5**(해운대·서면·광안리·남포동/자갈치·감천문화마을), **제주 2**(제주시·서귀포), **강원 1**(강릉), **전북 1**(전주 한옥마을). `keys` 정규식에 한글 별칭 포함, 첫 매칭 우선(순서 주의).
