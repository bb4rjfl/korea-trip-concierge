...
src/lib/courses.ts       페르소나 코스 데이터/엔진(D-025/D-029) — 태깅 스팟 서울35·부산16·제주15·경주11 + 11페르소나 테마맵(beauty/family/couple/kpop/foodie/culture/nightlife/nature/solo/budget+GENERIC) + 도시인식 조합엔진(반나절/1일/2일/3일·존클러스터·스왑대안, Seoul/Busan/Jeju/Gyeongju) + 1-day 시그니처 골든코스 6. 순수·결정적·테스트락.
