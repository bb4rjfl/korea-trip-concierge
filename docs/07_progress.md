...
src/tools/               12개 툴 (types, index, *.ts) — 지식툴4 즉시동작 + API툴8 실연동. getNowInfo=랜드마크 오버레이→VisitSeoul→TourAPI 폴백, getAreaGuide=29 동네, landmarks ~43 명소(D-017/018), explainKoreanService 11서비스
