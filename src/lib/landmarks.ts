...
export const LANDMARKS: Landmark[] = [
  ...
  // ── Seoul art: the venues a visitor asking for "galleries" actually wants ──
  // A generic assistant names these without hesitating. We were answering the
  // same question with romanised library names off a radius query, which is the
  // one outcome that makes us worse than the thing we are competing with. Ours
  // carry hours and a closed day, so we can also say whether to go today.
  {
    name: "Songeun Art Space",
    aliases: ["songeun", "songeun art space", "송은", "송은아트스페이스"],
    hours: [{ open: hm(11), close: hm(18, 30) }],
    hoursLabel: "11:00–18:30",
    closedDays: [0],
    closedLabel: "Sundays and public holidays",
    note: "Herzog & de Meuron's concrete wedge on Dosan-daero — free contemporary shows, and the building is the reason to go.",
    lat: 37.5223,
    lng: 127.0343,
  },
  {
    name: "K Museum of Contemporary Art",
    aliases: ["k museum", "k museum of contemporary art", "케이현대미술관", "k현대미술관"],
    hours: [{ open: hm(11), close: hm(19) }],
    hoursLabel: "11:00–19:00",
    closedDays: [1],
    closedLabel: "Mondays",
    note: "Immersive, media-heavy shows in Sinsa — the most photographed contemporary space in Gangnam.",
    lat: 37.5203,
    lng: 127.0231,
  },
  {
    name: "Horim Museum Sinsa",
    aliases: ["horim", "horim museum", "호림박물관", "호림미술관"],
    hours: [{ open: hm(10, 30), close: hm(18) }],
    hoursLabel: "10:30–18:00",
    closedDays: [0],
    closedLabel: "Sundays",
    note: "Korean ceramics and Buddhist art in a quiet Sinsa building — the calm alternative to the big museums.",
    lat: 37.5248,
    lng: 127.0227,
  },
  {
    name: "Kukje Gallery",
    aliases: ["kukje", "kukje gallery", "국제갤러리"],
    hours: [{ open: hm(10), close: hm(18) }],
    hoursLabel: "10:00–18:00 (Sun to 17:00)",
    note: "Korea's leading commercial gallery, beside Gyeongbokgung — free, and usually showing a name you know.",
    lat: 37.5793,
    lng: 126.9772,
  },
  {
    name: "Gallery Hyundai",
    aliases: ["gallery hyundai", "hyundai gallery", "갤러리현대"],
    hours: [{ open: hm(10), close: hm(18) }],
    hoursLabel: "10:00–18:00",
    closedDays: [1],
    closedLabel: "Mondays",
    note: "The oldest gallery in Korea, in Samcheong-dong — free entry, and a good first stop on the Bukchon walk.",
    lat: 37.5789,
    lng: 126.9808,
  },
  {
    name: "Amorepacific Museum of Art (APMA)",
    aliases: ["apma", "amorepacific museum", "amorepacific museum of art", "아모레퍼시픽미술관"],
    hours: [{ open: hm(10), close: hm(18) }],
    hoursLabel: "10:00–18:00",
    closedDays: [1],
    closedLabel: "Mondays",
    note: "In the Amorepacific headquarters at Sinyongsan — major international shows, and the lobby alone is worth the detour.",
    lat: 37.5271,
    lng: 126.9724,
  },
  {
    name: "Seoul Museum of Art (SeMA)",
    aliases: ["sema", "seoul museum of art", "서울시립미술관"],
    hours: [{ open: hm(10), close: hm(20) }],
    hoursLabel: "10:00–20:00 (weekends to 19:00 Nov–Feb)",
    closedDays: [1],
    closedLabel: "Mondays",
    note: "The city's own museum behind Deoksugung — free, central, and open late on weekdays.",
    lat: 37.5640,
    lng: 126.9738,
  },
  {
    name: "MMCA Seoul (National Museum of Modern and Contemporary Art)",
    aliases: ["mmca", "mmca seoul", "국립현대미술관", "현대미술관"],
    hours: [{ open: hm(10), close: hm(18) }],
    hoursLabel: "10:00–18:00 (Wed & Sat to 21:00)",
    note: "Beside Gyeongbokgung; ₩2,000 or free, and free entry every Wednesday evening until 21:00.",
    lat: 37.5785,
    lng: 126.9800,
  },
  {
  ...
  {
    name: "Cheonjiyeon Falls (Jeju)",
    aliases: ["cheonjiyeon", "cheonjiyeon falls", "천지연폭포", "천지연", "天地淵瀑布"],
    hours: [{ open: hm(9), close: hm(22) }],
    hoursLabel: "~09:00–22:00 (lit in the evening; last entry ~21:20)",
    note: "A lush Seogwipo waterfall a short walk from the harbour, floodlit after dark. Easy, paved trail — combine with Jeongbang Falls nearby.",
    approx: true,
    city: "Jeju",
    lat: 33.2469,
    lng: 126.5594,
  ...
  {
    name: "Udo (Cow Island, Jeju)",
    aliases: ["udo", "u-do", "cow island", "우도", "牛島"],
    hours: "daylight",
    hoursLabel: "Daylight — reached by ferry from Seongsan (~last boat early evening)",
    note: "A laid-back islet off Jeju's east coast — rent a scooter or e-bike to loop white-sand beaches and peanut-ice-cream cafés. Ferry from Seongsan port; check the last return.",
    approx: true,
    city: "Jeju",
    lat: 33.5057,
    lng: 126.9527,
  ...
  {
    name: "O'sulloc Tea Museum (Jeju)",
    aliases: ["osulloc", "o'sulloc", "osulloc tea museum", "오설록", "오설록티뮤지엄"],
    hours: [{ open: hm(9), close: hm(18) }],
    hoursLabel: "09:00–18:00",
    note: "A green-tea museum and café set among the west-Jeju tea fields — free entry, famous green-tea ice cream and roll cake, and photogenic rows of tea plants.",
    city: "Jeju",
    lat: 33.3057,
    lng: 126.2897,
  },
  {
    name: "Common Ground (Konkuk)",
    aliases: ["common ground", "커먼그라운드", "커먼그라운드 건대"],
    hours: [{ open: hm(11), close: hm(22) }],
    hoursLabel: "~11:00–22:00 (shops; eateries later)",
    note: "The big blue shipping-container mall by Konkuk University — indie fashion, street food, and pop-ups in a photogenic stack of containers. Lively in the evening.",
    approx: true,
    lat: 37.5409,
    lng: 127.0689,
  },
  {
    name: "The Hyundai Seoul (Yeouido)",
    aliases: ["the hyundai seoul", "hyundai seoul", "더현대서울", "더현대", "현대백화점 여의도"],
    hours: [{ open: hm(10, 30), close: hm(20) }],
    hoursLabel: "~10:30–20:00 (to 20:30 Fri–Sun; varies)",
    note: "Korea's flashiest department store on Yeouido — vast indoor garden, designer floors, and a famous basement food hall. Great rainy-day stop near the Han River.",
    approx: true,
    lat: 37.526,
    lng: 126.9283,
  },
  {
    name: "Oryukdo Skywalk (Busan)",
    aliases: ["oryukdo skywalk", "oryukdo", "오륙도스카이워크", "오륙도"],
    hours: [{ open: hm(9), close: hm(18) }],
    hoursLabel: "~09:00–18:00 (closed in high wind/rain)",
    note: "A glass-floored cliff walkway over the sea at Busan's southern tip, where the East and South Seas meet — bracing views; you wear shoe covers. Pair with the coastal Igidae trail.",
    approx: true,
    city: "Busan",
    lat: 35.1018,
    lng: 129.1238,
  ...
  {
    name: "Garden of Morning Calm (Gapyeong)",
    aliases: ["garden of morning calm", "morning calm", "아침고요수목원", "아침고요"],
    hours: [{ open: hm(8, 30), close: hm(19) }],
    hoursLabel: "~08:30–19:00 (later during the winter Lighting Festival)",
    note: "A landscaped arboretum in Gapyeong, dazzling during the winter Lighting Festival — a classic day trip paired with Nami Island. Hours extend in festival season.",
    approx: true,
    lat: 37.7442,
    lng: 127.3503,
  },

  // ── Historic cities & mountains (day-trips / overnights) ────────────────────
  {
    name: "Bulguksa Temple (Gyeongju)",
    aliases: ["bulguksa", "bulguksa temple", "seokguram", "불국사", "석굴암", "佛國寺"],
    hours: [{ open: hm(9), close: hm(18) }],
    hoursLabel: "~09:00–18:00 (Seokguram Grotto nearby, similar hours)",
    note: "Gyeongju's UNESCO Silla-era temple with the famous stone pagodas, paired with the Seokguram Grotto up the hill. The heart of a Gyeongju heritage day.",
    approx: true,
    city: "Gyeongju",
    lat: 35.7903,
    lng: 129.332,
  ...
  {
    name: "Cheomseongdae (Gyeongju)",
    aliases: ["cheomseongdae", "첨성대", "瞻星臺"],
    hours: "24h",
    hoursLabel: "Open 24 hours (outdoor; lit at night)",
    note: "The 7th-century stone observatory — one of Asia's oldest — set in the Gyeongju royal park near the Daereungwon tombs. Pretty floodlit after dark.",
    city: "Gyeongju",
    lat: 35.8348,
    lng: 129.219,
  },
  {
    name: "Hwaseong Fortress (Suwon)",
    aliases: ["hwaseong fortress", "suwon hwaseong", "hwaseong", "수원화성", "화성행궁", "華城"],
    hours: "daylight",
    hoursLabel: "Walls walkable daytime; paid palace/sites ~09:00–18:00",
    note: "A UNESCO 18th-century fortress wall you can walk around Suwon, with the Hwaseong Haenggung palace inside — an easy day trip from Seoul (~1 hr).",
    approx: true,
    city: "Suwon",
    lat: 37.288,
    lng: 127.0146,
  ...
  {
    name: "Seoraksan (Sokcho)",
    aliases: ["seoraksan", "mt seoraksan", "mount seoraksan", "설악산", "雪嶽山"],
    hours: "daylight",
    hoursLabel: "Daylight hiking — trail entry cutoffs vary by season; start early",
    note: "Korea's most spectacular national park near Sokcho on the east coast — granite peaks, a cable car to Gwongeumseong, and blazing autumn foliage. Start early for the high trails.",
    approx: true,
    trailCutoff: true,
    city: "Sokcho",
    lat: 38.1197,
  ...
  {
    name: "Songdo Central Park (Incheon)",
    aliases: ["songdo central park", "incheon songdo", "송도센트럴파크", "송도 센트럴파크"],
    hours: "24h",
    hoursLabel: "Open 24 hours (water-taxi & rentals daytime)",
    note: "A sleek waterfront park threading through Incheon's futuristic Songdo skyline — kayaks, a water taxi, and a moonlit promenade. Near the airport for a layover stroll.",
    city: "Incheon",
    lat: 37.3925,
    lng: 126.6394,
  },
  // ── More popular foreigner spots (D-037 content round) ───────────────────────
  {
    name: "Namsangol Hanok Village (Seoul)",
    aliases: ["namsangol", "namsangol hanok village", "남산골한옥마을", "남산골 한옥마을"],
    hours: [{ open: hm(9), close: hm(21) }],
    hoursLabel: "09:00–21:00 (Nov–Mar to 20:00)",
    closedDays: [1],
    closedLabel: "Mondays",
    note: "Five restored traditional hanok houses with a garden and crafts, free to enter, a short walk from Myeongdong — an easy taste of old Seoul.",
    approx: true,
    lat: 37.5591,
    lng: 126.9938,
  },
  {
    name: "Seodaemun Prison History Hall (Seoul)",
    aliases: ["seodaemun prison", "seodaemun", "서대문형무소", "서대문형무소역사관"],
    hours: [{ open: hm(9, 30), close: hm(18) }],
    hoursLabel: "09:30–18:00 (Nov–Feb to 17:00)",
    closedDays: [1],
    closedLabel: "Mondays",
    note: "A sobering colonial-era prison turned museum on Korea's independence movement — moving and well-explained in English.",
    approx: true,
    lat: 37.5744,
    lng: 126.9559,
  },
  {
    name: "Busan Tower (Diamond Tower, Yongdusan)",
    aliases: ["busan tower", "diamond tower", "yongdusan", "부산타워", "다이아몬드타워", "용두산공원"],
    hours: [{ open: hm(10), close: hm(22) }],
    hoursLabel: "10:00–22:00 (park open 24h)",
    note: "The observation tower crowning Yongdusan Park above Nampo — reach it by escalator from BIFF Square for harbour and night views.",
    approx: true,
    city: "Busan",
    lat: 35.1013,
    lng: 129.0323,
  ...
  {
    name: "Jusangjeolli Cliffs (Jeju)",
    aliases: ["jusangjeolli", "jusangjeolli cliffs", "주상절리", "대포주상절리"],
    hours: [{ open: hm(9), close: hm(18) }],
    hoursLabel: "09:00–18:00 (viewing deck; last entry ~17:40)",
    note: "Dramatic hexagonal basalt columns pounded by the surf on Jeju's south coast — best when the waves are high.",
    approx: true,
    city: "Jeju",
    lat: 33.2378,
    lng: 126.4271,
  ...
  {
    name: "Seokchon Lake (Jamsil)",
    aliases: ["seokchon lake", "seokchon", "석촌호수", "잠실 석촌호수"],
    hours: "24h",
    hoursLabel: "Open 24 hours (a public lakeside park)",
    note: "A ring of walking paths around a lake beside Lotte World Tower — Seoul's most famous cherry-blossom spot in early April, lovely and lit at night.",
    city: "Seoul",
    lat: 37.5089,
    lng: 127.1001,
  },
  {
    name: "Noryangjin Fisheries Market (Seoul)",
    aliases: ["noryangjin", "noryangjin fish market", "noryangjin fisheries", "노량진수산시장", "노량진 수산시장"],
    hours: "24h",
    hoursLabel: "Open ~24h (auctions ~01:00–06:00; stalls all day)",
    note: "Seoul's giant wholesale fish market — pick live seafood downstairs and have it prepared (hoe or grilled) at a restaurant upstairs. Busiest and freshest before dawn.",
    approx: true,
    city: "Seoul",
    lat: 37.5145,
    lng: 126.9425,
