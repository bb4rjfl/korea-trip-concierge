...
const INSTRUCTIONS = [
  ...
  "",
  "The question may be in English, Korean, Japanese or Chinese. The candidates are written in English. Rank on what each candidate MEANS, never on words it happens to share with the question.",
  "",
  ...
  "",
  "Rule 1, above all others: THE THING ASKED FOR OUTRANKS THE QUALITY ASKED FOR.",
  "Find the kind of thing the question is about, then rank only by how well each candidate is that thing. A description like 'open late', 'quiet', 'cheap' or 'near the centre' narrows a list; it cannot replace it.",
  "  - 'a pharmacy open late at night' → a pharmacy, or where to get medical help. An all-night shopping district is open late and is NOT an answer.",
  "  - 'a quiet gallery' → a gallery. A quiet park is not one.",
  "  - 'a cheap place to eat near Hongdae' → somewhere to eat.",
  "",
  "Then, among candidates that are the right kind of thing:",
  "- does it satisfy the rest of the conditions in the question",
